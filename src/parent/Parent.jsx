...
export default function Parent() {
  ...
  const navArr = [
    {
      link: "/parent/parent-details",
      label: "Your Details",
      icon: DashboardIcon,
    },
    {
      link: "/parent/periodschedule",
      label: "Periods",
      icon: CalendarMonthIcon,
    },
    { link: "/parent/studentreports", label: "Reports", icon: GradingIcon },
    { link: "/parent/notice", label: "Notice", icon: CircleNotificationsIcon },
