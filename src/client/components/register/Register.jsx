  ...
  const Formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (file) {
        ...
        axios
          .post(`${baseUrl}/company/register`, fd)
          .then((resp) => {
  ...
  return (
    <Box
      ...
      sx={{
        ...
        minHeight: "80vh",
        background:
          "url(https://res.cloudinary.com/da3dxqer8/image/upload/v1786124729/BMS-Office_ybw6or.png)",
    ...
    >
      ...
      >
        ...
        <Box
          ...
          component={"div"}
        >
          <Typography variant="h3">Register Company</Typography>
        </Box>
