  ...
  const handleEdit = (id) => {
    ...
    axios
      ...
      .then((resp) => {
        ...
        questionpaperFormik.setFieldValue(
          "section",
          resp.data.data?.section?._id,
        );
        questionpaperFormik.setFieldValue(
          "subject",
          resp?.data?.data?.subject?._id || "",
        );
        questionpaperFormik.setFieldValue(
          "teacher",
          resp?.data?.data?.teacher?._id,
        ) || "";
        questionpaperFormik.setFieldValue(
          "examination",
          resp?.data?.data?.examination?._id || "",
        );
        questionpaperFormik.setFieldValue(
          "marksLimit",
          resp?.data?.data?.marksLimit || 0,
        );
        questionpaperFormik.setFieldValue(
          "avg_marks_limit",
          resp?.data?.data?.avg_marks_limit || 0,
        );
      ...
      .catch((e) => {
        handleMessage("error", e.resp.data.message);
      });
  };
      ...
      <Box>
        <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
          ...
          >
            ...
            <Tab
              label={isEdit ? "Edit Questionpaper" : "Add New Questionpaper"}
            />
            <Tab label="View List" />
          </Tabs>
        </Box>
              ...
              >
                ...
                <Box>
                  <Autocomplete
                    ...
                    onBlur={() =>
                      questionpaperFormik.setFieldTouched("class", true)
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        ...
                        fullWidth
                        error={
                          questionpaperFormik.touched.class &&
                          Boolean(questionpaperFormik.errors.class)
                        }
                        helperText={
                          questionpaperFormik.touched.class &&
                          questionpaperFormik.errors.class
                        }
                      />
                    )}
                  />
                ...
                <Box>
                  <Autocomplete
                    ...
                    onBlur={() =>
                      questionpaperFormik.setFieldTouched("section", true)
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        ...
                        fullWidth
                        error={
                          questionpaperFormik.touched.section &&
                          Boolean(questionpaperFormik.errors.section)
                        }
                        helperText={
                          questionpaperFormik.touched.section &&
                          questionpaperFormik.errors.section
                        }
                      />
                    )}
                  />
                ...
                <Box>
                  ...
                  />
                  {questionpaperFormik.touched.name &&
                ...
                <Box>
                  <Autocomplete
                    ...
                    onBlur={() =>
                      questionpaperFormik.setFieldTouched("year", true)
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        ...
                        fullWidth
                        error={
                          questionpaperFormik.touched.year &&
                          Boolean(questionpaperFormik.errors.year)
                        }
                        helperText={
                          questionpaperFormik.touched.year &&
                          questionpaperFormik.errors.year
                        }
                      />
                    )}
                  />
                ...
                <Autocomplete
                  ...
                  onBlur={() =>
                    questionpaperFormik.setFieldTouched("subject", true)
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      ...
                      fullWidth
                      error={
                        questionpaperFormik.touched.subject &&
                        Boolean(questionpaperFormik.errors.subject)
                      }
                      helperText={
                        questionpaperFormik.touched.subject &&
                        questionpaperFormik.errors.subject
                      }
                    />
                  )}
                />
                ...
                <Autocomplete
                  ...
                  onBlur={() =>
                    questionpaperFormik.setFieldTouched("teacher", true)
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      ...
                      fullWidth
                      error={
                        questionpaperFormik.touched.teacher &&
                        Boolean(questionpaperFormik.errors.teacher)
                      }
                      helperText={
                        questionpaperFormik.touched.teacher &&
                        questionpaperFormik.errors.teacher
                      }
                    />
                  )}
                />
                ...
                <Autocomplete
                  ...
                  onBlur={() =>
                    questionpaperFormik.setFieldTouched("examination", true)
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      ...
                      fullWidth
                      error={
                        questionpaperFormik.touched.examination &&
                        Boolean(questionpaperFormik.errors.examination)
                      }
                      helperText={
                        questionpaperFormik.touched.examination &&
                        questionpaperFormik.errors.examination
                      }
                    />
                  )}
                />
                ...
                <Box>
                  ...
                  {questionpaperFormik.touched.marksLimit &&
                ...
                <Box>
                  ...
                  {questionpaperFormik.touched.avg_marks_limit &&
