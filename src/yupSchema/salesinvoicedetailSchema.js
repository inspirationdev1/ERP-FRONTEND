...
export const salesinvoicedetailSchema = yup.object({
  ...
  discountMonth: yup.number().typeError("feeAmount amount must be a number"),
  discountPer: yup.number().typeError("feeAmount amount must be a number"),
  discountAmount: yup.number().typeError("feeAmount amount must be a number"),
  netAmount: yup
    .number()
