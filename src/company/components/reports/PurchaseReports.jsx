...
export default function PurchaseReports() {
  ...
  const handlePrint = async () => {
    ...
    if (selectedReport.reportId === "purchase-summary-supplier-report") {
      window.open(
        `/company/PurchaseSummarySupplierPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
        "_blank",
      );
  ...
  const Formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (values.reportId == "other-report") {
        if (!values.supplier) {
          setDataError("Select the Supplier");
          setIsDataValid(false);
          return;
        }
      }
  ...
  const fetchReportNames = async () => {
    try {
      const reportsData = [
        {
          reportId: "supplier-list-report",
          reportName: "Supplier-List Report",
        },
        {
          reportId: "purchase-summary-supplier-report",
          reportName: "Purchase-Summary-Supplier Report",
        },
        {
