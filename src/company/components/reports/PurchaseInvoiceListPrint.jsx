...
export default function PurchaseInvoiceListPrint() {
    ...
    try {
      ...
      if (dataParam) {
        ...
        const response = await axios.get(
          `${baseUrl}/purchasereports/purchase-invoice-list-print`,
          {
        ...
        <div className="w-full flex-1 min-h-[calc(100vh-70px)]">
          {pdfUrl ? (
            <iframe
              ...
              title="Purchase Invoice List PDF"
          ...
          <div className="w-full py-4 flex justify-center gap-3 bg-white">
            <button
              onClick={() => {
                ...
                link.href = pdfUrl;
                link.download = "PurchaseInvoiceList.pdf";
                link.click();
              }}
