...
import { companyreportsSchema } from "../../../yupSchema/companyreportsSchema";
...
export default function FinanceReports() {
  ...
  const handlePrint = async () => {
    ...
    try {
      if (selectedReport.reportId == "income-expense-report") {
        ...
        window.open(
          `/company/FinanceReportsPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/ExpenseReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/IncomeReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/PendingFeesReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/PaidFeesReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/PendingExpensesReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/PaidExpensesReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/ChartOfAccountReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/TrialBalanceReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/ProfitOrLossReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/BalanceSheetReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/StatementOfAccountStudentReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
        ...
        window.open(
          `/company/StatementOfAccountLedgerReportPrint?data=${encodeURIComponent(JSON.stringify(data))}`,
          "_blank",
        );
      }
    } catch (error) {
  ...
  const Formik = useFormik({
    ...
    // validationSchema: companyreportsSchema,
    onSubmit: (values) => {
      if (!values.reportId) {
      ...
      if (
        values.reportId == "expense-report" ||
  ...
  const fetchReportNames = async () => {
    try {
      const reportsData = [
        ...
        {
          reportId: "pending-expenses-report",
          reportName: "Pending Expenses Report",
        },
        {
          reportId: "paid-expenses-report",
          reportName: "Paid Expenses Report",
        },
        ...
        {
          reportId: "statement-of-account-student",
          reportName: "Statement of Account(Student)",
        },
        {
          reportId: "statement-of-account-ledger",
          reportName: "Statement of Account(Ledger)",
        },
      ];
  ...
  const fetchAccountlevels = async () => {
    try {
      const accountlevelsResponse = await axios.get(
        `${baseUrl}/accountlevel/fetch-with-query`,
        {
          params: {},
        },
      ); // Fetch based on class
          ...
          <Paper sx={{ padding: "20px", margin: "10px" }}>
            ...
            >
              ...
              >
                ...
                {/* Academic Year */}
                {selectedReport &&
                  selectedReport.reportId === "income-expense-report" && (
                    <Box>
                      <Autocomplete
                        options={years}
                ...
                {/* From Date */}
                {selectedReport &&
                  (selectedReport.reportId === "expense-report" ||
                    ...
                    <Box>
                      <Autocomplete
                        ...
                        getOptionLabel={(option) =>
                          option.accountlevel_name +
                          "-" +
                          option.accountlevel_code
                        }
                        ...
                        onBlur={() =>
                          Formik.setFieldTouched("accountlevel", true)
                        }
                        renderInput={(params) => (
                          <TextField
                            {...params}
                  ...
                  (selectedReport.reportId === "chart-of-account" ||
                    ...
                    <Box>
                      <Autocomplete
                        ...
                        onBlur={() =>
                          Formik.setFieldTouched("accountledger", true)
                        }
                        renderInput={(params) => (
                          <TextField
                            {...params}
